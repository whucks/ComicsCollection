...
namespace ComicRelief.Models
{
    ...
    public class Marvel
    {
        ...
        public IEnumerable<Comic> GetComicsStarsWithTitle(string startsWithTitle, int? Limit)
        {
            var request = CreateRequest("/comics");
            request.AddParameter("titleStartsWith", startsWithTitle);
        ...
        public IEnumerable<Comic> GetMyComics(string isbn  = null, 
            string startsWithTitle = null,
            string comicID = null,
            int? Limit = null)
        {
            var request = CreateRequest("/comics");

            if (startsWithTitle != null && !startsWithTitle.Equals("") )
            {
                request.AddParameter("titleStartsWith", startsWithTitle);
            }
            ...
            var data = response.Data;
            var code = (data as ComicDataWrapper).Code;
            var status = (data as ComicDataWrapper).Status;
    ...
    [Serializable]
    internal class LimitExceededException : Exception
    {
